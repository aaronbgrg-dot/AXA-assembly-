...
│    TRABAJADOR      │      │     INMUEBLE       │
├────────────────────┤      ├────────────────────┤
│ id_trabajador(PK)  │      │ id_inmueble (PK)   │
│ id_usuario (FK)    │      │ id_usuario (FK)    │
│ id_departamentoFK  │      │ direccion          │
│ puesto             │      │ ciudad             │
│ salario            │      │ tipo               │
│ fecha_contratacion │      │ precio             │
└────────────────────┘      │ metros_cuadrados   │
          │                 │ habitaciones       │
          │                 │ baños              │
          ▼                 │ estado             │
...
└────────────────────┘                  │
          ...
          ┌────────────────────┐          ┌────────────────────┐
          │ INMUEBLE_SERVICIO  │          │  INMUEBLE_OFERTA   │
          ├────────────────────┤          ├────────────────────┤
          │ id_inmueble (FK)   │          │ id_inmueble (FK)   │
          │ id_servicio (FK)   │          │ id_oferta (FK)     │
          └────────────────────┘          └────────────────────┘
                      │                                  │
                      │                                  │
                      ▼                                  ▼
